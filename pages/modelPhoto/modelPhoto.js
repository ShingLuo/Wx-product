  ...
  onLoad: function (options) {
    ...
    wx.getStorage({
      ...
      success: ele => {
        ...
        console.log(this.data.seriesInfo)
        //请求图片页面信息数据
        this.getImgData()
        
        //请求页面换车型信息数据
        let ajaxUrl = app.ajaxurl + 'index.php?r=weex/product/get-product-picture-change-list&subId=' + ele.data.F_SubCategoryId + '&seriesId=' + ele.data.F_SeriesId;
